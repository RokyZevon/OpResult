...
public sealed class OpResultUsageAnalyzerTests
{
    ...
    [Fact]
    public async Task ErrorAccess_InsideOrBranchWithPartialTrueProof_ReportsDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var flag = false;
            var result = LoadUser(found: true);
            if ((result.IsOk || flag) || result.IsErr)
            {
                _ = result.Error;
            }
            """);
    ...
    [Fact]
    public async Task ValueAccess_InsideExplicitIsOkTrueBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
    ...
    [Fact]
    public async Task ValueAccess_InsideExplicitIsErrFalseBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
    ...
    [Fact]
    public async Task ValueAccess_InsideExplicitIsOkNotFalseBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
    ...
    [Fact]
    public async Task ValueAccess_InsideExplicitIsErrNotTrueBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
    ...
    [Fact]
    public async Task ValueAccess_InsidePropertyPatternIsOkBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
            if (result is { IsOk: true })
            {
                _ = result.Value;
            }
            """);
    ...
    [Fact]
    public async Task ErrorAccess_InsideElseOfPropertyPatternIsOkBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ValueAccess_InsidePatternIsErrFalseBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: true);
            if (result.IsErr is false)
            {
                _ = result.Value;
            }
            """);
    ...
    [Fact]
    public async Task ErrorAccess_InsideExplicitIsErrTrueBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ErrorAccess_InsideExplicitTrueEqualsIsErrBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
            if (true == result.IsErr)
            {
                _ = result.Error;
            }
            """);
    ...
    [Fact]
    public async Task ErrorAccess_InsideExplicitIsOkFalseBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ValueAccess_InsideDifferentIndexerIsOkBranch_ReportsDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsForSourceAsync(
            """
            #nullable enable
            ...
            public sealed class Probe
            {
                public void Run(ResultBag results)
                {
                    if (results[0].IsOk)
                    {
                        _ = results[1].Value;
    ...
    [Fact]
    public async Task ValueAccess_AfterPayloadMemberWriteInsideIsOkBranch_DoesNotReportDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsForSourceAsync(
            """
            #nullable enable
            ...
            {
                public static OpResult<User> LoadUser() => OpResults.Ok(new User());
    ...
    [Fact]
    public async Task ParenthesizedValueNullCheck_ReportsPseudoBranchDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ParenthesizedErrorNullCheck_ReportsPseudoBranchDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ErrorMessageNonEmptyChecks_ReportPseudoBranchDiagnostics()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ErrorMessageNonEmptyCheck_InsideIsErrBranch_DoesNotReportPseudoBranchDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task ParenthesizedErrorMessageEmptyCheck_ReportsPseudoBranchDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task PatternNullChecks_ReportPseudoBranchDiagnostics()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
    ...
    [Fact]
    public async Task QualifiedStringEmptyChecks_ReportPseudoBranchDiagnostics()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsForSourceAsync(
            """
            #nullable enable
    ...
    [Fact]
    public async Task DirectErrorMessageRebuildWithNullInner_ReportsChainLossDiagnostic()
    {
        var diagnostics = await AnalyzerTestHost.GetDiagnosticsAsync(
            """
            var result = LoadUser(found: false);
